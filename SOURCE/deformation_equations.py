...
from matrix_operations import (matrix_multiply_vector, matrix_multiply,
...
class VelocityGradient(Equation):
    ...
    def initialize(self, d_idx, d_gradv, d_dgt, d_eps, t):
        i, idx = declare("int", 2)
    ...
    def loop(self, d_idx, d_gradv, d_l_mat, s_idx, s_m, s_rho, VIJ, DWIJ):
        ...
        for i in range(3):
            ...
            iidx = 3 * i
            for j in range(3):
                d_gradv[idx + iidx + j] += dvij * dwij[j]
